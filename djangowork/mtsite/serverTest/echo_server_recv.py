...
while True :   
    ...
    if getMsg1 != -1 :
        if getMsg1[0] == 1 :
            socketProgramming('192.168.35.195', 9999, getMsg1)   
            
    if getMsg2 != -1 :
         if getMsg2[0] == 2 :
            socketProgramming('192.168.35.195', 9998, getMsg2)
    
    if getMsg3 != -1 :
        if getMsg3[0] == 3 :
            socketProgramming('192.168.35.195', 10000, getMsg3)
        
    if getMsg4 != -1 :
        if getMsg4[0] == 4 :
            socketProgramming('192.168.35.195', 9996, getMsg4)
            
    if getMsg5 != -1 :
        if getMsg5[0] == 5 :
            socketProgramming('192.168.35.195', 9995, getMsg5)
