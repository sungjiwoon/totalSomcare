...
# ✍️ 프로젝트 개요
<img width="80%" src="https://github.com/sungjiwoon/totalSomcare/assets/59862752/c6d11426-b49c-4a6d-b94d-04394498c041"><br><br>
스마트 홈의 기본이 되는 통합 제어시스템과 이를 위한 IoT 허브 시스템의 하드웨어를 모두 개발한 작품입니다. <br> 
게이트웨이 서버로 대표 되는 하드웨어를 통해 스마트 기기의 상태를 모니터링 하다가, <br>
특정 센서 값을 받으면 액션을 취해줌으로써 스마트기기를 제어할 수 있습니다. <br>
